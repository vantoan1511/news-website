...
<footer class="footer">
    <div class="container">
                ...
                <div class="block">
                    ...
                    <div class="block-body">
                        <figure class="foot-logo">
                            <img src="/static/web/images/toansnewslogo.png" class="img-responsive" alt="Logo">
                        </figure>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="block">
                    <h1 class="block-title">Popular Tags
                        <div class="right"><a href="#">See All <i
                    ...
                    <div class="block-body">
                        <article class="article-mini">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="/static/web/images/news/img12.jpg" alt="Sample Article">
                                    </a>
                                </figure>
                                <div class="padding">
                        ...
                        <article class="article-mini">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="/static/web/images/news/img14.jpg" alt="Sample Article">
                                    </a>
                                </figure>
                                <div class="padding">
                        ...
                        <article class="article-mini">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="/static/web/images/news/img15.jpg" alt="Sample Article">
                                    </a>
                                </figure>
                                <div class="padding">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    COPYRIGHT &copy; MAGZ 2023. ALL RIGHT RESERVED.
                </div>
            </div>
        </div>
    </div>
