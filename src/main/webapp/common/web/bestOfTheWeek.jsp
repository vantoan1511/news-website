        ...
        <div class="owl-carousel owl-theme carousel-1">
            <article class="article">
                <div class="inner">
                    <figure>
                        <a href="single.html">
                            <img src="/static/web/images/news/img03.jpg" alt="Sample Article">
                        </a>
                    </figure>
                    <div class="padding">
                        <div class="detail">
            ...
            <article class="article">
                <div class="inner">
                    <figure>
                        <a href="single.html">
                            <img src="/static/web/images/news/img01.jpg" alt="Sample Article">
                        </a>
                    </figure>
                    <div class="padding">
                        <div class="detail">
            ...
            <article class="article">
                <div class="inner">
                    <figure>
                        <a href="single.html">
                            <img src="/static/web/images/news/img11.jpg" alt="Sample Article">
                        </a>
                    </figure>
                    <div class="padding">
                        <div class="detail">
