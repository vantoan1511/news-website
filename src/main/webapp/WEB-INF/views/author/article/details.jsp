            ...
            <div class="card">
                <div class="card-body row">
                    <div class="col-md-3 col-sm-auto">
                        <button onclick="handleArticleSaveButtonClick(event, '#form', false, false)"
                                id="saveBtn"
                    ...
                    <div class="col-auto">
                        <button onclick="handleArticleSaveButtonClick(event, '#form', true, false)"
                                id="saveAndCloseBtn"
                    ...
                    <div class="col-auto">
                        <button onclick="handleArticleSaveButtonClick(event, '#form', false, true)"
                                id="saveAndNewBtn"
                                class="btn btn-block btn-default">
                    ...
                    <c:if test="${model.id ne 0}">
                        ...
                        <c:choose>
                            <c:when test="${model.statusCode eq 'draft'}">
                                <div class="col-sm-auto">
                                    <button onclick="handleArticlePublishButtonClick(event, ${model.id})"
                                            id="publish-btn"
                                            class="btn btn-block bg-gradient-success">
